...
-- r[1]	=>  Location: PIN_136,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- r[2]	=>  Location: PIN_3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- r[3]	=>  Location: PIN_34,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- r[4]	=>  Location: PIN_103,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- r[5]	=>  Location: PIN_30,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- r[6]	=>  Location: PIN_104,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- r[7]	=>  Location: PIN_33,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- a[7]	=>  Location: PIN_2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a[14]	=>  Location: PIN_43,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a[15]	=>  Location: PIN_142,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a[0]	=>  Location: PIN_144,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- a[11]	=>  Location: PIN_1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a[12]	=>  Location: PIN_7,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \encoder|r[0]~1_combout\ = \a[13]~input_o\ $ (\a[3]~input_o\ $ (\a[0]~input_o\ $ (\a[1]~input_o\)))
...
-- Equation(s):
-- \encoder|r[1]~0_combout\ = \a[15]~input_o\ $ (\a[14]~input_o\ $ (\a[7]~input_o\ $ (\a[8]~input_o\)))
...
-- Equation(s):
-- \encoder|r\(0) = \encoder|r[0]~1_combout\ $ (\a[6]~input_o\ $ (\encoder|r[1]~0_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \encoder|r[0]~1_combout\,
	datab => \a[6]~input_o\,
	datac => \encoder|r[1]~0_combout\,
	combout => \encoder|r\(0));
...
-- Equation(s):
-- \encoder|r[1]~2_combout\ = \a[2]~input_o\ $ (\a[9]~input_o\ $ (\a[4]~input_o\ $ (\a[1]~input_o\)))
...
-- Equation(s):
-- \encoder|r[2]~4_combout\ = \a[2]~input_o\ $ (\a[5]~input_o\ $ (\a[0]~input_o\ $ (\a[1]~input_o\)))
...
-- Equation(s):
-- \encoder|r[2]~3_combout\ = \a[9]~input_o\ $ (\a[6]~input_o\ $ (\a[13]~input_o\ $ (\a[14]~input_o\)))
...
-- Equation(s):
-- \encoder|r[2]~5_combout\ = \encoder|r[2]~4_combout\ $ (\encoder|r[2]~3_combout\ $ (\a[7]~input_o\ $ (\a[10]~input_o\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \encoder|r[2]~4_combout\,
	datab => \encoder|r[2]~3_combout\,
	datac => \a[7]~input_o\,
	datad => \a[10]~input_o\,
...
-- Equation(s):
-- \encoder|r[5]~6_combout\ = \a[2]~input_o\ $ (\a[10]~input_o\ $ (\a[3]~input_o\ $ (\a[1]~input_o\)))
...
-- Equation(s):
-- \encoder|r[3]~7_combout\ = \encoder|r[5]~6_combout\ $ (\a[6]~input_o\ $ (\encoder|r[1]~0_combout\ $ (\a[11]~input_o\)))
...
-- Equation(s):
-- \encoder|r[6]~8_combout\ = \a[2]~input_o\ $ (\a[4]~input_o\ $ (\a[0]~input_o\ $ (\a[1]~input_o\)))
...
-- Equation(s):
-- \encoder|r[4]~9_combout\ = \a[12]~input_o\ $ (\encoder|r[6]~8_combout\ $ (\a[11]~input_o\ $ (\encoder|r[2]~3_combout\)))
...
PORT MAP (
	...
	datac => \a[11]~input_o\,
	datad => \encoder|r[2]~3_combout\,
	combout => \encoder|r[4]~9_combout\);

-- Location: LCCOMB_X4_Y18_N6
\encoder|r[7]~10\ : cycloneive_lcell_comb
-- Equation(s):
-- \encoder|r[7]~10_combout\ = \a[15]~input_o\ $ (\a[5]~input_o\ $ (\a[7]~input_o\ $ (\a[14]~input_o\)))
...
-- Equation(s):
-- \encoder|r\(5) = \a[12]~input_o\ $ (\a[13]~input_o\ $ (\encoder|r[5]~6_combout\ $ (\encoder|r[7]~10_combout\)))
...
-- Equation(s):
-- \encoder|r\(6) = \a[11]~input_o\ $ (\a[7]~input_o\ $ (\encoder|r[6]~8_combout\))
...
-- Equation(s):
-- \encoder|r[7]~11_combout\ = \a[2]~input_o\ $ (\a[6]~input_o\ $ (\a[0]~input_o\))
...
-- Equation(s):
-- \encoder|r\(7) = \a[12]~input_o\ $ (\encoder|r[7]~11_combout\ $ (\a[13]~input_o\ $ (\encoder|r[7]~10_combout\)))
